...
address:
  ...
  - code: 2
    address: University at Florida, Smathers Libraries Academic Research & Consulting Services, P. O. Box 117000, Gainesville, FL 32611-7000
  - code: 3
...
library(dplyr)
library(stringr)
googlesheets4::gs4_auth(email = "cornelioid@gmail.com")
Sys.sleep(10)
```
...
We include a PRISMA checklist as Supplemental Table 1.
...
tab_synthesis |> 
  ...
  mutate(across(c(-Cases, -Features), ~ str_c(., "\\hspace{6em}"))) |> 
  knitr::kable(
    align = "lllllrr",
    caption = paste0(
      "\\label{tab:synthesis}",
...
Data collected or encoded for included studies are publicly available in two Google Sheets. Code used to analyze these data and generate this manuscript is publicly available in a GitHub repository.

* Properties of included studies: <https://docs.google.com/spreadsheets/d/1tpWMhYH2pyRT55K7n2J2XFs-kEV_JTuCDmXzJ4BBgNo/>
* Composite techniques: <https://docs.google.com/spreadsheets/d/1xvDJwiLBoI2oz8fxHJ5MjNmiju_RAlK7RJv-wXe1DAs/>
* Analysis and manuscript code: <https://github.com/corybrunson/imsr>
