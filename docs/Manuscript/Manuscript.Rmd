...
Our methods followed prepared plans, which we describe in detail in the Appendix.
...
```{r fig:year, fig.align='center', out.width="80%", echo=FALSE}
#| fig.cap =
#| "\\label{fig:year}
